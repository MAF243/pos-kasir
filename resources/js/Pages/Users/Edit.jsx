                ...
                <form onSubmit={submit}>
                    <div className="p-6 space-y-6">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            <p className="text-sm text-gray-500 mb-4">Leave password fields blank if you do not want to change the password.</p>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700">New Password</label>
                                    <input
                                        type="password"
                                        className={`mt-1 block w-full px-3 py-2 border ${errors.password ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-primary-500 focus:border-primary-500'} rounded-md shadow-sm sm:text-sm bg-white`}
                                        value={data.password}
                                ...
                                <div>
                                    ...
                                    <input
                                        type="password"
                                        className={`mt-1 block w-full px-3 py-2 border border-gray-300 focus:ring-primary-500 focus:border-primary-500 rounded-md shadow-sm sm:text-sm bg-white`}
